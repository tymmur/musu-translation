...
sub loadFromScriptsInc
{
	...
	print FILE "Translation Progress (autogenerated)\n\n";
	...
	print FILE "Unreviewed lines are made by people on HongFire, who has left long ago. Quality varies greatly and some, but certainly not all, can be used.\n";
	
	
	print FILE "\nCommon route:\n";
	print FILE "Lines: " . sprintf("%.3f", $translated_common_lines*100) . "%\n";
	print FILE "Bytes: " . sprintf("%.3f", $translated_common_bytes*100) . "%\n";
	
	print FILE "\nTotal: (reviewed, reachable without going through untranslated sections)\n";
	print FILE "Lines: " . sprintf("%.3f", $translated_all_lines*100) . "%\n";
	print FILE "Bytes: " . sprintf("%.3f", $translated_all_bytes*100) . "%\n";
	
	print FILE "\nTotal: (including unreviewed and unlockable content)\n";
	print FILE "Lines: " . sprintf("%.3f", ($total_translated_lines / $total_lines)*100) . "%\n";
	print FILE "Bytes: " . sprintf("%.3f", ($total_translated_byte_count / $total_byte_count)*100) . "%\n";
	
	print FILE "\nTotal line count: ". $total_lines . "\n";
	print FILE "Total byte count: ". $total_byte_count . "\n";
	close FILE;
}
